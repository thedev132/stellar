export default function Features4() {
    return (
        <section className="ca60c">
                <div className="ca60c cknuf chyag ck7tl cj5a0">

                    {/* <!-- Blurred shape --> */}
                    <div className="c431g cl2cn clndv c2aec c0mvq cim0s cclmt cx692 citek" aria-hidden="true">
                    ...
                    <div className="cz74e c4w2r cpnha ctga0">
            
                        {/* <!-- Section header --> */}
                        <div className="cz30m cz74e cpnha">
                            <h2 className="cr09c cmmug cr2fi chaw1 ch3zp cicf4 ckopp cjeaj">Why trust us?</h2>
                            <p className="cd2du cfoch">Many desktop publishing packages and web page editors now use lorem ipsum as their default model text, and a search will uncover many web sites still in their infancy.</p>
                        </div>

                        {/* <!-- Rows --> */}
                        <div className="c9aqo cw6m1">
                            {/* <!-- Row --> */}
                            <div className="cpb5v c9c9x cj4vv">
                                <div>
                                    <div className="cwkz6 cmmug cpb1t c6mtw cicf4 camr2 ciph8 cjeaj">API Authorization</div>
                                </div>
                                <div className="cjvyj cq0og cld7d c5rb1 clfvo">
                                    {/* <!-- Feature --> */}
                                    <div>
                                        <div className="ceq85 cs2x1 cxwsr cmru4">
                                            <svg className="cw4n2 c03dg" xmlns="http://www.w3.org/2000/svg" width="16" height="16">
                                            ...
                                            <h4 className="ciph8 crdoi">Discussions</h4>
                                        </div>
                                        <p className="cqnsz cfoch">Login box must find the right balance for the user convenience, privacy and security.</p>
                                    </div>
                                    {/* <!-- Feature --> */}
                                    <div>
                                        <div className="ceq85 cs2x1 cxwsr cmru4">
                                            ...
                                            <h4 className="ciph8 crdoi">Team views</h4>
                                        </div>
                                        <p className="cqnsz cfoch">Login box must find the right balance for the user convenience, privacy and security.</p>
                                    </div>
                                    {/* <!-- Feature --> */}
                                    <div>
                                        <div className="ceq85 cs2x1 cxwsr cmru4">
                                            ...
                                            <h4 className="ciph8 crdoi">Powerful search</h4>
                                        </div>
                                        <p className="cqnsz cfoch">Login box must find the right balance for the user convenience, privacy and security.</p>
                                    </div>
                                </div>
                            ...
                            <div className="cpb5v">
                                <div>
                                    <div className="cwkz6 cmmug cpb1t c6mtw cicf4 camr2 ciph8 cjeaj">User Management</div>
                                </div>
                                <div className="cjvyj cq0og cld7d c5rb1 clfvo">
                                    {/* <!-- Feature --> */}
                                    <div>
                                        <div className="ceq85 cs2x1 cxwsr cmru4">
                                            ...
                                            <h4 className="ciph8 crdoi">Analytics</h4>
                                        </div>
                                        <p className="cqnsz cfoch">Login box must find the right balance for the user convenience, privacy and security.</p>
                                    </div>
                                    {/* <!-- Feature --> */}
                                    <div>
                                        <div className="ceq85 cs2x1 cxwsr cmru4">
                                            ...
                                            <h4 className="ciph8 crdoi">Notifications</h4>
                                        </div>
                                        <p className="cqnsz cfoch">Login box must find the right balance for the user convenience, privacy and security.</p>
                                    </div>
                                    {/* <!-- Feature --> */}
                                    <div>
                                        <div className="ceq85 cs2x1 cxwsr cmru4">
                                            ...
                                            <h4 className="ciph8 crdoi">Integrations</h4>
                                        </div>
                                        <p className="cqnsz cfoch">Login box must find the right balance for the user convenience, privacy and security.</p>
                                    </div>
                                </div>
                            ...
                            <div className="cpb5v">
                                <div>
                                    <div className="cwkz6 cmmug cpb1t c6mtw cicf4 camr2 ciph8 cjeaj">Standard Security</div>
                                </div>
                                <div className="cjvyj cq0og cld7d c5rb1 clfvo">
                                    {/* <!-- Feature --> */}
                                    <div>
                                        <div className="ceq85 cs2x1 cxwsr cmru4">
                                            ...
                                            <h4 className="ciph8 crdoi">Privacy</h4>
                                        </div>
                                        <p className="cqnsz cfoch">Login box must find the right balance for the user convenience, privacy and security.</p>
                                    </div>
                                    {/* <!-- Feature --> */}
                                    <div>
                                        <div className="ceq85 cs2x1 cxwsr cmru4">
                                            ...
                                            <h4 className="ciph8 crdoi">Data export</h4>
                                        </div>
                                        <p className="cqnsz cfoch">Login box must find the right balance for the user convenience, privacy and security.</p>
                                    </div>
                                    {/* <!-- Feature --> */}
                                    <div>
                                        <div className="ceq85 cs2x1 cxwsr cmru4">
                                            ...
                                            <h4 className="ciph8 crdoi">Real-time sync</h4>
                                        </div>
                                        <p className="cqnsz cfoch">Login box must find the right balance for the user convenience, privacy and security.</p>
                                    </div>
                                </div>
